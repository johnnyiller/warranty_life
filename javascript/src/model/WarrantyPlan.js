...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WarrantyLifeApi.WarrantyPlan = factory(root.WarrantyLifeApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('productMaxPrice')) {
        obj['productMaxPrice'] = ApiClient.convertToType(data['productMaxPrice'], 'Number');
      }
  ...
  /**
   * @member {Number} productMaxPrice
   */
  exports.prototype['productMaxPrice'] = undefined;
  /**
